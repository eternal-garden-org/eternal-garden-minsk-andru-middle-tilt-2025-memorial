      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-3">
          ...
          <p className="text-base text-muted-foreground">
            Иван прожил счастливую жизнь с женой Ольгой Сергеевной. Вместе
            ...
            стала врачом. У Ивана было трое внуков, которых он обожал:
        ...
        <div className="space-y-3">
          ...
          <div className="text-base text-muted-foreground space-y-4">
            <p>
              По профессии Иван был архитектором, и его работы до сих пор
            ...
            <p>
              Но его жизнь — это не только чертежи и проекты. Иван любил
