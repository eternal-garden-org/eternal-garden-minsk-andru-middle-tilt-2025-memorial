...
const wordsData = [
  ...
  {
    id: "2",
    text: "Иван был моим лучшим другом на протяжении 40 лет. Мы вместе учились в институте, вместе начинали свой путь в строительстве. Он был не просто коллегой — он был человеком, который никогда не подводил, всегда держал слово. Я помню, как в трудные 90-е он помог мне с работой, когда я остался без средств к существованию. Такая верность дружбе и человеческая порядочность редко встречаются в наше время.",
    author: {
  ...
  {
    id: "3",
    text: "Наши 35 лет вместе пролетели как один день. Ваня был не просто мужем, он был моей опорой, моим защитником, моим лучшим другом. Он мог заставить меня улыбаться даже в самые тяжелые дни. Каждое утро готовил мне кофе, даже когда спешил на работу. Его забота и любовь наполняли наш дом. Теперь, когда его нет рядом, я чувствую его присутствие в каждом уголке нашего дома, в каждом воспоминании, которое мы создали вместе.",
    author: {
